        ...
        <div class="layui-card-body">
            <div class="layui-tab layui-tab-brief">
                <ul class="layui-tab-title">
                    <li<?php if($tabid == 'pc') echo ' class="layui-this"';?>>Mẫu máy tính</li>
                    <li<?php if($tabid == 'wap') echo ' class="layui-this"';?>>Mẫu di động</li>
                    <li><a onclick="layer.load();" href="<?=links('skins','index')?>">Trung tâm mẫu</a></li>
                </ul>
                                ...
                                <div style="padding: 10px;">
                                    ...
                                    <div class="layui-col-xs6 layui-col-sm4 layui-col-md2">
                                        <div class="comic-skin center">
                                            ...
                                            <div class="cmd">
                                            <?php if($row['init'] == 0){ ?>
                                                <div class="layui-btn layui-btn-xs layui-btn-radius" onclick="Admin.skin_init('<?=links('setting','skins_init','pc')?>','<?=$row['path']?>');">Đặt làm mặc định</div>
                                            <?php }else{ ?>
                                                <div class="layui-btn layui-btn-xs layui-btn-radius layui-btn-disabled">Mẫu mặc định</div>
                                            <?php } ?>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div style="padding: 10px;">
                                    ...
                                    <div class="layui-col-xs6 layui-col-sm4 layui-col-md2">
                                        <div class="comic-skin center">
                                            ...
                                            <div class="cmd">
                                            <?php if($row['init'] == 0){ ?>
                                                <div class="layui-btn layui-btn-xs layui-btn-radius" onclick="Admin.skin_init('<?=links('setting','skins_init','wap')?>','<?=$row['path']?>');">Đặt làm mặc định</div>
                                            <?php }else{ ?>
                                                <div class="layui-btn layui-btn-xs layui-btn-radius layui-btn-disabled">Mẫu mặc định</div>
                                            <?php } ?>
                                            </div>
